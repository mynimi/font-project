...
!function(e,t){"function"==typeof define&&define.amd?define(["jquery"],function(n){return t(e,n)}):"object"==typeof module&&"object"==typeof module.exports?module.exports=t(e,require("jquery")):e.lity=t(e,e.jQuery||e.Zepto)}("undefined"!=typeof window?window:this,function(e,t){"use strict";function n(){h[g>0?"addClass":"removeClass"]("lity-active")}function r(e){var n=t.Deferred();return T?(e.one(T,n.resolve),setTimeout(n.resolve,500)):n.resolve(),n.promise()}function i(e,n,r){if(1===arguments.length)return t.extend({},e);if("string"==typeof n){if("undefined"==typeof r)return"undefined"==typeof e[n]?null:e[n];e[n]=r}else t.extend(e,n);return this}function o(e){for(var t,n=decodeURI(e).split("&"),r={},i=0,o=n.length;o>i;i++)n[i]&&(t=n[i].split("="),r[t[0]]=t[1]);return r}function s(e,n){return e+(e.indexOf("?")>-1?"&":"?")+t.param(n)}function a(e){return t('<span class="lity-error"/>').append(e)}function u(e){if(!m.test(e))return!1;var n=t('<img src="'+e+'">'),r=t.Deferred(),i=function(){r.reject(a("Failed loading image"))};return n.on("load",function(){return 0===this.naturalWidth?i():void r.resolve(n)}).on("error",i),r.promise()}function l(e){var n;try{n=t(e)}catch(r){return!1}if(!n.length)return!1;var i=t('<span style="display:none !important" class="lity-inline-placeholder"/>');return n.after(i).on("lity:ready",function(e,t){t.one("lity:remove",function(){i.before(n.addClass("lity-hide")).remove()})})}function c(e){var n,r=e;return n=v.exec(e),n&&(r=s("https://www.youtube"+(n[2]||"")+".com/embed/"+n[4],t.extend({autoplay:1},o(n[5]||"")))),n=y.exec(e),n&&(r=s("https://player.vimeo.com/video/"+n[3],t.extend({autoplay:1},o(n[4]||"")))),n=x.exec(e),n&&(r=s("https://www.google."+n[3]+"/maps?"+n[6],{output:n[6].indexOf("layer=c")>0?"svembed":"embed"})),'<div class="lity-iframe-container"><iframe frameborder="0" allowfullscreen src="'+r+'"></iframe></div>'}function f(e){function o(e){27===e.keyCode&&c()}function s(){var e=p.documentElement.clientHeight?p.documentElement.clientHeight:Math.round(d.height());m.css("max-height",Math.floor(e)+"px").trigger("lity:resize",[h])}function a(e,n){h&&(m=t(n),d.on("resize",s),s(),h.find(".lity-loader").each(function(){var e=t(this);r(e).always(function(){e.remove()})}),h.removeClass("lity-loading").find(".lity-content").empty().append(m),m.removeClass("lity-hide").trigger("lity:ready",[h,e]),x.resolve())}function u(e,r,i,s){x=t.Deferred(),g++,n(),h=t(i.template).addClass("lity-loading").appendTo("body"),i.esc&&d.on("keyup",o),setTimeout(function(){h.addClass("lity-opened lity-"+e).on("click","[data-lity-close]",function(e){t(e.target).is("[data-lity-close]")&&c()}).trigger("lity:open",[h,s]),t.when(r).always(t.proxy(a,null,s))},0)}function l(e,n,r){var i,o,s=t.extend({},b,y);if(n=t.extend({},w,v,n),n.handler&&s[n.handler])o=s[n.handler](e,f),i=n.handler;else{var a={};t.each(["inline","iframe"],function(e,t){s[t]&&(a[t]=s[t]),delete s[t]});var l=function(t,n){return n?(o=n(e,f),o?(i=t,!1):void 0):!0};t.each(s,l),i||t.each(a,l)}return o&&t.when(c()).done(t.proxy(u,null,i,o,n,r)),!!o}function c(){if(h){var e=t.Deferred();return x.done(function(){g--,n(),d.off("resize",s).off("keyup",o),m.trigger("lity:close",[h]),h.removeClass("lity-opened").addClass("lity-closed");var t=h,i=m;h=null,m=null,r(i.add(t)).always(function(){i.trigger("lity:remove",[t]),t.remove(),e.resolve()})}),e.promise()}}function f(e){if(!e.preventDefault)return f.open(e);var n=t(this),r=n.data("lity-target")||n.attr("href")||n.attr("src");if(r){var i=n.data("lity-options")||n.data("lity");l(r,i,n)&&(n.blur(),e.preventDefault())}}var h,m,v={},y={},x=t.Deferred().resolve();return f.handlers=t.proxy(i,f,y),f.options=t.proxy(i,f,v),f.open=function(e,t,n){return l(e,t,n),f},f.close=function(){return c(),f},f.options(e)}var p=e.document,d=t(e),h=t("html"),g=0,m=/(^data:image\/)|(\.(png|jpe?g|gif|svg|webp|bmp|ico|tiff?)(\?\S*)?$)/i,v=/(youtube(-nocookie)?\.com|youtu\.be)\/(watch\?v=|v\/|u\/|embed\/?)?([\w-]{11})(.*)?/i,y=/(vimeo(pro)?.com)\/(?:[^\d]+)?(\d+)\??(.*)?$/,x=/((maps|www)\.)?google\.([^\/\?]+)\/?((maps\/?)?\?)(.*)/i,b={image:u,inline:l,iframe:c},w={esc:!0,handler:null,template:'<div class="lity" tabindex="-1"><div class="lity-wrap" data-lity-close><div class="lity-loader">Loading...</div><div class="lity-container"><div class="lity-content"></div><button class="lity-close" type="button" title="Close (Esc)" data-lity-close>×</button></div></div></div>'},T=function(){var e=p.createElement("div"),t={WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd otransitionend",transition:"transitionend"};for(var n in t)if(void 0!==e.style[n])return t[n];return!1}();return f.version="1.6.6",f.handlers=t.proxy(i,f,b),f.options=t.proxy(i,f,w),t(p).on("click","[data-lity]",f()),f});
$(document).ready(function(){"use strict";$(".parent").click(function(){$(this).siblings(".level-two").is(":hidden")?($(".menu .level-two").slideUp(),$(this).siblings(".level-two").slideToggle()):$(this).siblings(".level-two").slideUp()}),$(".navtoggle").click(function(){$(".menu").toggleClass("active")}),$(".menu .fa").append('<a href="#"> submenu öffnen</a>'),$("a[href^='http']").attr("target","_blank"),$(window).resize(function(){function e(){var e=$(window).scrollTop();Math.abs(n-e)<=r||(e>n&&e>i?$("nav").css({top:-i}):e+$(window).height()<$(document).height()&&$("nav").css({top:"0"}),n=e)}var t,n=0,r=15,i=$(".menu").outerHeight(),o=$("header").outerHeight();$(window).width();$(".backtotop").click(function(){$("body,html").animate({scrollTop:0},500)}),$(window).scroll(function(){$(window).scrollTop()>o+i&&(t=!0)}),setInterval(function(){t&&(e(),t=!1)},250)}).resize()}),$(document).on("lity:open",function(){$('.lity-iframe-container iframe[src*="instagram"]')&&$(".lity").addClass("insta")});
